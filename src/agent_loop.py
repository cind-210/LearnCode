...
from . import types
from .compact.auto_compact import auto_compact, should_auto_compact
from .compact.manual_compact import manual_compact
from .compact.microcompact import microcompact
from .compact.context_collapse import (
...
from .memory import MemoryStore, get_default_memory_store
...
from .skills import get_default_skill_registry
from .tool import ToolRegistry, ToolResult, ToolContext
...
from .utils.tool_result_storage import (
...
async def _apply_compression(
    ...
    if should_auto_compact(state.messages, model):
